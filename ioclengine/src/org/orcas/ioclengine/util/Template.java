...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		CUSTOM, DIV, ENUM_LITERAL, EQUAL, EXCLUDES, EXCLUDING, EXISTS, FIRST,
		FLATTEN, FLOOR, FOR, FOR_ALL, GT, GTE, INCLUDES, INCLUDES_ALL,
		INCLUDING, INDEX_OF, INSERT_AT, INSTANTIATION, INTERSECTION, IS_EMPTY,
		IS_UNIQUE, LAST, LOG, LT, LTE, MAX, MIN, MINUS, MOD, NOT, NOT_EMPTY,
		NOT_EQUAL, OCL_AS_TYPE, OCL_IS_KIND_OF, OCL_IS_TYPE_OF,
		OCL_IS_UNDEFINED, ONE, OR, PREPEND, PRODUCT, PROPERTY_CALL, RAISE,
		REJECT, RETURN, ROUND, SELECT, SIZE, SORTED_BY, SUBSTRING,
		SUB_ORDERED_SET, SUB_SEQUENCE, SUM, SWITCH, SYMMETRIC_DIFFERENCE, TRY,
		TO_INTEGER, TO_LOWER, TO_REAL, TO_UPPER, UNION, VARIABLE, WHILE, XOR};
