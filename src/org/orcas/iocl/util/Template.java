...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		AS_ORDERED_SET, AS_SEQUENCE, AS_SET, BLOCK, BREAK, CLOSURE, COLLECT,
		COLLECTION, COLLECT_NESTED,	CONCAT, CONTINUE, COUNT, DIV, EQUAL,
		...
		IS_EMPTY, IS_UNIQUE, LAST, LT, LTE, MAX, MIN, MOD, NOT, NOT_EMPTY,
