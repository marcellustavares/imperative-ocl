 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.IfExpImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.IfExpImpl#getThenExpression <em>Then Expression</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.IfExpImpl#getElseExpression <em>Else Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void setThenExpression(OclExpression newThenExpression) {
		if (newThenExpression != thenExpression) {
			...
			if (newThenExpression != null)
				msgs = ((InternalEObject)newThenExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.IF_EXP__THEN_EXPRESSION, null, msgs);
	...
	public void setElseExpression(OclExpression newElseExpression) {
		if (newElseExpression != elseExpression) {
			...
			if (newElseExpression != null)
				msgs = ((InternalEObject)newElseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.IF_EXP__ELSE_EXPRESSION, null, msgs);
