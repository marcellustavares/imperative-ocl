 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.CollectionLiteralExpImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.CollectionLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionLiteralExpImpl extends LiteralExpImpl implements CollectionLiteralExp {
	...
	public EList<CollectionLiteralPart> getPart() {
		if (part == null) {
			part = new EObjectContainmentWithInverseEList<CollectionLiteralPart>(CollectionLiteralPart.class, this, OclPackage.COLLECTION_LITERAL_EXP__PART, OclPackage.COLLECTION_LITERAL_PART__COLLECTION_LITERAL_EXP);
		}
		return part;
	}
