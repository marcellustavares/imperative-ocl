 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.CollectionItemImpl#getItem <em>Item</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionItemImpl extends CollectionLiteralPartImpl implements CollectionItem {
	...
	public NotificationChain basicSetItem(OclExpression newItem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_ITEM__ITEM, oldItem, newItem);
	...
	public void setItem(OclExpression newItem) {
		if (newItem != item) {
			...
			if (item != null)
				msgs = ((InternalEObject)item).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_ITEM__ITEM, null, msgs);
			if (newItem != null)
				msgs = ((InternalEObject)newItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_ITEM__ITEM, null, msgs);
			msgs = basicSetItem(newItem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_ITEM__ITEM, newItem, newItem));
	}
