 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.OperationCallExpImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.OperationCallExpImpl#getReferredOperation <em>Referred Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationCallExpImpl extends FeaturePropertyCallImpl implements OperationCallExp {
	...
	public EList<OclExpression> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<OclExpression>(OclExpression.class, this, OclPackage.OPERATION_CALL_EXP__ARGUMENT);
		}
		return argument;
	}
