 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.imperativeocl.impl.IntegerLiteralExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralExpImpl extends NumericLiteralExpImpl implements IntegerLiteralExp {
	...
	protected EClass eStaticClass() {
		return ImperativeOclPackage.Literals.INTEGER_LITERAL_EXP;
	}
	...
	public void setIntegerSymbol(Integer newIntegerSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImperativeOclPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImperativeOclPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL:
