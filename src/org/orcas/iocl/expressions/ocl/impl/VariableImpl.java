 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.VariableImpl#getInitExpression <em>Init Expression</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.VariableImpl#getLetExp <em>Let Exp</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.VariableImpl#getBindParameter <em>Bind Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends TypedElementImpl implements Variable {
	...
	public NotificationChain basicSetInitExpression(OclExpression newInitExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OclPackage.VARIABLE__INIT_EXPRESSION, oldInitExpression, newInitExpression);
	...
	public void setInitExpression(OclExpression newInitExpression) {
		if (newInitExpression != initExpression) {
			...
			if (initExpression != null)
				msgs = ((InternalEObject)initExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.VARIABLE__INIT_EXPRESSION, null, msgs);
			if (newInitExpression != null)
				msgs = ((InternalEObject)newInitExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.VARIABLE__INIT_EXPRESSION, null, msgs);
			msgs = basicSetInitExpression(newInitExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.VARIABLE__INIT_EXPRESSION, newInitExpression, newInitExpression));
	}
	...
	public LetExp getLetExp() {
		if (eContainerFeatureID() != OclPackage.VARIABLE__LET_EXP) return null;
	...
	public NotificationChain basicSetLetExp(LetExp newLetExp, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLetExp, OclPackage.VARIABLE__LET_EXP, msgs);
		return msgs;
	}
	...
	public void setLetExp(LetExp newLetExp) {
		if (newLetExp != eInternalContainer() || (eContainerFeatureID() != OclPackage.VARIABLE__LET_EXP && newLetExp != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.VARIABLE__LET_EXP, newLetExp, newLetExp));
	}
	...
	public Parameter getBindParameter() {
		if (bindParameter != null && bindParameter.eIsProxy()) {
			...
			if (bindParameter != oldBindParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OclPackage.VARIABLE__BIND_PARAMETER, oldBindParameter, bindParameter));
			}
		}
	...
	public void setBindParameter(Parameter newBindParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.VARIABLE__BIND_PARAMETER, oldBindParameter, bindParameter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OclPackage.VARIABLE__LET_EXP:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OclPackage.VARIABLE__LET_EXP:
				return getLetExp();
			case OclPackage.VARIABLE__BIND_PARAMETER:
