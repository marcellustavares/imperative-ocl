...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		PREPEND, PRODUCT, PROPERTY_CALL, RAISE, REJECT, RETURN, ROUND, SELECT,
		SIZE, SORTED_BY, SUBSTRING, SUB_ORDERED_SET, SUB_SEQUENCE, SUM, SWITCH,
		SYMMETRIC_DIFFERENCE, TRY, TO_INTEGER, TO_LOWER, TO_REAL, TO_UPPER,
		UNION, VARIABLE, WHILE, XOR};
