 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.emof.impl.PackageImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.emof.impl.PackageImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.emof.impl.PackageImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends NamedElementImpl implements org.orcas.iocl.expressions.emof.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<org.orcas.iocl.expressions.emof.Package> nestedPackage;
	 ...
	 * @generated
	 */
	public EList<org.orcas.iocl.expressions.emof.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentEList<org.orcas.iocl.expressions.emof.Package>(org.orcas.iocl.expressions.emof.Package.class, this, EmofPackage.PACKAGE__NESTED_PACKAGE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmofPackage.PACKAGE__NESTED_PACKAGE:
				...
				getNestedPackage().addAll((Collection<? extends org.orcas.iocl.expressions.emof.Package>)newValue);
				return;
			case EmofPackage.PACKAGE__URI:
