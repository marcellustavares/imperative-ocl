 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.CallExpImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CallExpImpl extends OclExpressionImpl implements CallExp {
	...
	public NotificationChain basicSetSource(OclExpression newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OclPackage.CALL_EXP__SOURCE, oldSource, newSource);
	...
	public void setSource(OclExpression newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.CALL_EXP__SOURCE, null, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.CALL_EXP__SOURCE, null, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.CALL_EXP__SOURCE, newSource, newSource));
	}
