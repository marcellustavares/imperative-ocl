 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.imperativeocl.impl.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableExpImpl extends OclExpressionImpl implements VariableExp {
	...
	protected EClass eStaticClass() {
		return ImperativeOclPackage.Literals.VARIABLE_EXP;
	}
		...
		if (referredVariable != null && referredVariable.eIsProxy()) {
			...
			if (referredVariable != oldReferredVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImperativeOclPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
			}
		}
	...
	public void setReferredVariable(Variable newReferredVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImperativeOclPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImperativeOclPackage.VARIABLE_EXP__REFERRED_VARIABLE:
