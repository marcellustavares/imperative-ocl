 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ClassImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ClassImpl#getOwnedOperation <em>Owned Operation</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ClassImpl#getSuperClass <em>Super Class</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ClassImpl#getIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassImpl extends TypeImpl implements org.orcas.iocl.expression.emof.Class {
	/**
	 ...
	 * @ordered
	 */
	protected EList<org.orcas.iocl.expression.emof.Class> superClass;
	 ...
	 * @generated
	 */
	public EList<org.orcas.iocl.expression.emof.Class> getSuperClass() {
		if (superClass == null) {
			superClass = new EObjectResolvingEList<org.orcas.iocl.expression.emof.Class>(org.orcas.iocl.expression.emof.Class.class, this, EmofPackage.CLASS__SUPER_CLASS);
		}
		return superClass;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmofPackage.CLASS__SUPER_CLASS:
				getSuperClass().clear();
				getSuperClass().addAll((Collection<? extends org.orcas.iocl.expression.emof.Class>)newValue);
				return;
			case EmofPackage.CLASS__IS_ABSTRACT:
