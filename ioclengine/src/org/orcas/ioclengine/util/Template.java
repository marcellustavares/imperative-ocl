...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		NOT_EQUAL, OCL_AS_TYPE, OCL_IS_KIND_OF, OCL_IS_TYPE_OF, OCL_IS_UNDEFINED,
		ONE, OR, PREPEND, PRODUCT, PROPERTY_CALL, RAISE, REJECT, RETURN, ROUND,
		SELECT, SIZE, SORTED_BY, SUBSTRING, SUB_ORDERED_SET, SUB_SEQUENCE, SUM,
		SWITCH, SYMMETRIC_DIFFERENCE, TRY, TO_INTEGER, TO_LOWER, TO_REAL,
		TO_UPPER, UNION, VARIABLE, WHILE, XOR};
