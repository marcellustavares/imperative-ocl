 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.emof.impl.ElementImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link org.orcas.iocl.expressions.emof.impl.ElementImpl#getOwnedComment <em>Owned Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ElementImpl extends ObjectImpl implements Element {
	...
	public EList<Tag> getTag() {
		if (tag == null) {
			tag = new EObjectWithInverseResolvingEList.ManyInverse<Tag>(Tag.class, this, EmofPackage.ELEMENT__TAG, EmofPackage.TAG__ELEMENT);
		}
		return tag;
	}
