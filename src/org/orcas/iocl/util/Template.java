...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		DIV, EQUAL, EXCLUDES, EXCLUDING, EXISTS, FIRST, FLATTEN, FLOOR, FOR_ALL,
		GT, GTE, INCLUDES, INCLUDES_ALL, INCLUDING, INDEX_OF, INSERT_AT,
		INTERSECTION, IS_EMPTY, IS_UNIQUE, LAST, LT, LTE, MAX, MIN, MOD, NOT,
		NOT_EMPTY, NOT_EQUAL, OCL_AS_TYPE, OCL_IS_KIND_OF, OCL_IS_TYPE_OF, ONE,
		OR, PREPEND, PRODUCT, RAISE, REJECT, RETURN, ROUND, SELECT, SIZE,
		SORTED_BY, SUBSTRING, SUB_ORDERED_SET, SUB_SEQUENCE, SUM, SWITCH,
