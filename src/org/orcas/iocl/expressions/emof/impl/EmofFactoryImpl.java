...
public class EmofFactoryImpl extends EFactoryImpl implements EmofFactory {
	...
	public static EmofFactory init() {
		try {
			EmofFactory theEmofFactory = (EmofFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.orcas.org/spec/iocl/1.0/emof"); //$NON-NLS-1$ 
	 ...
	 * @generated
	 */
	public org.orcas.iocl.expressions.emof.Class createClass() {
	 ...
	 * @generated
	 */
	public org.orcas.iocl.expressions.emof.Object createObject() {
	 ...
	 * @generated
	 */
	public org.orcas.iocl.expressions.emof.Package createPackage() {
