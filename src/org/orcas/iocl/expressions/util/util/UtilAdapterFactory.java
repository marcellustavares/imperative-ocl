 ...
 * $Id$
 */
package org.orcas.iocl.expressions.util.util;
...
import org.orcas.iocl.expressions.util.*;
 ...
 * <!-- end-user-doc -->
 * @see org.orcas.iocl.expressions.util.UtilPackage
 * @generated
 */
public class UtilAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.orcas.iocl.expressions.util.Visitor <em>Visitor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
