...
public enum Template {
	...
	public static Template[] TEMPLATES = {
		...
		LT, LTE, MAX, MIN, MINUS, MOD, NOT, NOT_EMPTY, NOT_EQUAL, OCL_AS_TYPE,
		OCL_IS_KIND_OF, OCL_IS_TYPE_OF, ONE, OR, PREPEND, PRODUCT,
		PROPERTY_CALL, RAISE, REJECT, RETURN, ROUND, SELECT, SIZE, SORTED_BY,
