 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ParameterImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ParameterImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.orcas.iocl.expression.emof.impl.ParameterImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends MultiplicityElementImpl implements Parameter {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmofPackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
