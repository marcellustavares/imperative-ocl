 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expressions.ocl.impl.TupleLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleLiteralExpImpl extends LiteralExpImpl implements TupleLiteralExp {
	...
	public EList<TupleLiteralPart> getPart() {
		if (part == null) {
			part = new EObjectContainmentWithInverseEList<TupleLiteralPart>(TupleLiteralPart.class, this, OclPackage.TUPLE_LITERAL_EXP__PART, OclPackage.TUPLE_LITERAL_PART__TUPLE_LITERAL_EXP);
		}
		return part;
	}
