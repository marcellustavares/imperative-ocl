 ...
 * <ul>
 *   <li>{@link org.orcas.iocl.expression.imperativeocl.impl.UnlimitedNaturalExpImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnlimitedNaturalExpImpl extends NumericLiteralExpImpl implements UnlimitedNaturalExp {
	...
	protected EClass eStaticClass() {
		return ImperativeoclPackage.Literals.UNLIMITED_NATURAL_EXP;
	}
	...
	public void setSymbol(Integer newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImperativeoclPackage.UNLIMITED_NATURAL_EXP__SYMBOL, oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImperativeoclPackage.UNLIMITED_NATURAL_EXP__SYMBOL:
				return getSymbol();
		}
