...
import org.orcas.iocl.expression.util.*;
...
public class UtilFactoryImpl extends EFactoryImpl implements UtilFactory {
	...
	public static UtilFactory init() {
		try {
			UtilFactory theUtilFactory = (UtilFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.orcas.org/spec/iocl/1.0/util"); 
